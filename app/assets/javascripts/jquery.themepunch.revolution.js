...
(function (e, t) {
            ...
            for (var E = 0; E < n.slots; E++) {
                ...
                if (f(8)) {
                    s.find(".slot ")
                        .last()
                        .find(".slotslide")
                        .append('<img class="ieeightfallbackimage" src="' + w + '" style="width:100%;height:auto">');
                    S(s, n);
                }
            }
        } else {
    ...
    var k = function (e, n) {
        ...
        if (o.data("lazyload") != t && o.data("lazyload") != "undefined" && o.data("lazydone") != 1) {
            if (!f(8)) o.css({ backgroundImage: 'url("' + s.find(".defaultimg").data("lazyload") + '")' });
            else {
    ...
    var O = function (n, r, i, s, o, u) {
        ...
        if (a == 4 || a == 5) {
            ...
            o.find(".slotslide").each(function (t) {
                ...
                D.add(punchgs.TweenLite.to(n, P * 3, { transformPerspective: 600, force3D: "auto", top: 0 + r.height, opacity: 0.5, rotation: r.rotate, ease: punchgs.Power2.easeInOut, delay: i }), 0);
                k.add(D, 0);
            });
            u.find(".slotslide").each(function (t) {
                var n = e(this);
                var i = (t * P) / r.slots;
                if (a == 5) i = ((r.slots - t - 1) * P) / r.slots / 1.5;
                D.add(punchgs.TweenLite.from(n, P * 3, { top: 0 - r.height, opacity: 0.5, rotation: r.rotate, force3D: "auto", ease: punchgs.Power2.easeInOut, delay: i }), 0);
                k.add(D, 0);
            });
        }
        if (a == 6) {
        ...
        if (a == 12 || a == 13 || a == 14 || a == 15) {
            ...
            if (p != 1) {
                if (a == 12) k.add(punchgs.TweenLite.to(G, K, { left: 0 - j + "px", force3D: "auto", scale: W, opacity: z, rotation: r.rotate, ease: V }), 0);
                ...
                else if (a == 14) k.add(punchgs.TweenLite.to(G, K, { top: F + "px", force3D: "auto", scale: W, opacity: z, rotation: r.rotate, ease: V }), 0);
            }
        }
        if (a == 16) {
            var D = new punchgs.TimelineLite();
            ...
            k.add(
                punchgs.TweenLite.fromTo(
                    s.find(".tp-half-one"),
                    C / 800,
                    { width: j, height: F / 2, position: "absolute", top: "0px", left: "0px", force3D: "auto", transformOrigin: "center top" },
                    { scale: ot, rotation: et, y: 0 - F - F / 4, autoAlpha: 0, ease: punchgs.Power2.easeInOut }
                ),
                0
            );
            k.add(
                punchgs.TweenLite.fromTo(
                    s.find(".tp-half-two"),
                    C / 800,
                    { width: j, height: F, overflow: "hidden", position: "absolute", top: F / 2, left: "0px", force3D: "auto", transformOrigin: "center bottom" },
                    {
                        scale: ut,
                        rotation: tt,
                        y: F + F / 4,
            ...
            if (s.html() != null)
                k.add(
                    punchgs.TweenLite.fromTo(
                        i,
                        (C - 200) / 1e3,
                        { scale: at, x: (r.width / 4) * it, y: (F / 4) * st, rotation: nt, force3D: "auto", transformOrigin: "center center", ease: punchgs.Power2.easeOut },
            ...
            u.find(".slotslide").each(function (t) {
                ...
                D.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { transformStyle: "flat", backfaceVisibility: "hidden", left: 0, rotationY: r.rotate, z: 10, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationX: ct },
                        { left: 0, rotationY: 0, top: 0, z: 0, scale: 1, force3D: "auto", rotationX: 0, delay: (t * 50) / 1e3, ease: punchgs.Power2.easeInOut }
                    ),
                    0
                );
                D.add(punchgs.TweenLite.to(n, 0.1, { autoAlpha: 1, delay: (t * 50) / 1e3 }), 0);
                k.add(D);
            });
            o.find(".slotslide").each(function (t) {
                var n = e(this);
                ...
                D.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { transformStyle: "flat", backfaceVisibility: "hidden", autoAlpha: 1, rotationY: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationX: 0 },
            ...
            u.find(".slotslide").each(function (t) {
                ...
                k.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1500,
                        { left: pt, rotationX: 40, z: -600, opacity: z, top: 0, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationY: ct },
                ...
                k.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { rotationX: 40, z: -600, opacity: z, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationY: ct },
                        { rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: (t * 50) / 1e3, ease: punchgs.Power2.easeInOut }
                    ),
                    0
                );
                k.add(punchgs.TweenLite.to(n, 0.1, { opacity: 1, force3D: "auto", delay: (t * 50) / 1e3 + C / 2e3 }), 0);
            });
            o.find(".slotslide").each(function (t) {
                var n = e(this);
                if (N != 1) {
                ...
                k.add(punchgs.TweenLite.to(n, 0.1, { force3D: "auto", opacity: 0, delay: (t * 50) / 1e3 + (C / 1e3 - C / 1e4) }), 0);
            });
        }
        if (a == 21 || a == 25) {
            setTimeout(function () {
            ...
            u.find(".slotslide").each(function (t) {
                ...
                k.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { left: 0, transformStyle: "flat", rotationX: rot2, z: 0, autoAlpha: 0, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationY: ct },
            ...
            o.find(".slotslide").each(function (t) {
                ...
                k.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { left: 0, transformStyle: "flat", rotationX: 0, z: 0, autoAlpha: 1, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationY: 0 },
                        { left: 0, rotationX: rot2, top: 0, z: 0, autoAlpha: 1, force3D: "auto", scale: 1, rotationY: ct, ease: punchgs.Power1.easeInOut }
                    ),
                    0
                );
            });
            ...
            u.find(".slotslide").each(function (t) {
                ...
                k.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { left: dt, rotationX: r.rotate, force3D: "auto", opacity: z, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ht, rotationY: ct },
            ...
            o.find(".slotslide").each(function (t) {
                ...
                k.add(
                    punchgs.TweenLite.fromTo(
                        n,
                        C / 1e3,
                        { left: 0, autoAlpha: 1, rotationX: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ht, rotationY: 0 },
                        { left: dt, autoAlpha: 1, rotationX: r.rotate, top: 0, scale: 1, rotationY: ct, delay: (t * 50) / 500, ease: punchgs.Power2.easeInOut }
                    ),
                    0
                );
            });
            ...
            if (d == 0) {
                ...
                if (f.hasClass("tp-videolayer") || f.find("iframe").length > 0 || f.find("video").length > 0) {
                    ...
                    f.find("iframe").each(function () {
                        ...
                        if (f.data("videoposter") != t && f.data("videoposter").length > 2 && f.data("autoplay") != true && !s) {
                            ...
                            else punchgs.TweenLite.set(f.find(".tp-thumb-image"), { autoAlpha: 1 });
                        }
                ...
                if (!s) {
                    ...
                    if (f.data("splitin") == "chars" || f.data("splitin") == "words" || f.data("splitin") == "lines" || f.data("splitout") == "chars" || f.data("splitout") == "words" || f.data("splitout") == "lines") {
                        if (f.find("a").length > 0) f.data("mySplitText", new punchgs.SplitText(f.find("a"), { type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted" }));
